				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input type="text" id="name" name="name" placeholder="Họ tên" name="full_name" required>
						</div>
						<div class="form-block">
						...
						<div class="form-block">
							...
							<input name="email" type="email"  name="email"  required placeholder="expample@gmail.com">
						</div>

						<div class="form-block">
							<label for="adress">Địa chỉ*</label>
							<input type="text" id="adress" placeholder="Street Address" required name="addres"> 
						</div>
								...
								<ul class="payment_methods methods">
									...
									<li class="payment_method_cheque">
										...
										<div class="payment_box payment_method_cheque" style="display: none;">
											...
											<br>- Chủ TK: Trương Thị Thanh Thi
