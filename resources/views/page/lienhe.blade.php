			...
			<div class="row">
				<div class="col-sm-8">
					...
					<form action="#" method="post" class="contact-form">	
						...
						<div class="form-block">
							<textarea name="your-message" style="resize: none;" rows="1" placeholder="Lời Nhắn"></textarea>
						</div>
						<div class="form-block">
				...
				<div class="col-sm-4">
					...
					<p ><img src="source/assets/dest/images/map.png">&nbsp;&nbsp;
						204 Cao Lỗ, Phường 4, Quận 8, Thành Phố Hồ Chí Minh
					</p>
					<div class="space20">&nbsp;</div>
					<h6 class="contact-title">Số Điện Thoại</h6><br>
					<p><img src="source/assets/dest/images/phone.png">&nbsp;&nbsp;
						0866807340 <br>
						
					</p>
					<div class="space20">&nbsp;</div>
					<h6 class="contact-title">Email</h6><br>
					<p><img src="source/assets/dest/images/email.png">&nbsp;&nbsp;
						nhannam945@gmail.com <br>
