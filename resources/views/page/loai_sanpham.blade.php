									...
									<div class="single-item">
										...
										<div class="single-item-body">
											...
											<p class="single-item-price" style="font-size: 18px">
												@if($spk->promotion_price !=0)
												<span class="flash-del1">{{number_format($spk->unit_price)}} VND</span>
												<span class="flash-sale">{{number_format($spk->promotion_price)}}VND</
												@else
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-body">
											...
											<p class="single-item-price" style="font-size: 18px">
												@if($sp->promotion_price !=0)
												<span class="flash-del1">{{number_format($sp->unit_price)}} VND</span>
												<span class="flash-sale">{{number_format($sp->promotion_price)}}VND</
												@else
