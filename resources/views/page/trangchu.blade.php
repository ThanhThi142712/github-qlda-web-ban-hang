...
<div class="bannercontainer" >
	    <div class="banner" >
				<ul>
					...
					data-lazyload="undefined" data-bgfit="cover" data-bgposition="center center" 
		...
		<div class="tp-bannertimer"></div>
           ...
           <!--
				<div class="single-item-caption">
					...
					<a class="beta-btn primary" href="{{route('giatang')}}">Giá Tăng<i class="fa fa-chevron-right"></i></a>
					<div class="clearfix"></div>
				</div>
		
			<div class="single-item-caption">
											
					<a class="beta-btn primary" href="{{route('giagiam')}}">Giá Giảm<i class="fa fa-chevron-right"></i></a>
					<div class="clearfix"></div>
				</div>
			-->
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div>
											...
											@if($new->promotion_price==0)
											    <span class="flash-del" font-size: 15px;>{{number_format($new->unit_price)}} VND</span>
											 @else
											    <span class="flash-del1" font-size: 15px;>{{number_format($new->unit_price)}} VND</span>
											    <span class="flash-sale" font-size: 15px;>{{number_format($new->promotion_price)}} VND</span>
										     @endif
											</p>
										</div>
										<div class="single-item-caption">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-body">
											...
											<p class="single-item-price1">
												<span class="flash-del1">{{number_format($spkm->unit_price)}} VND</span>
